...
Trivially, any string is a subsequence of itself and an empty string is a subsequence
of any string.
...
Idea:
    Greedy, we start from the longest sequence itself, check if it's a subsequence of the other.
...
if __name__ == '__main__':
    sl = Solution()
    tmp = sl.findLUSlength("abcd", "abcde")
    print(tmp)
